...
>
    <div
            class="absolute md:relative w-full justify-end bg-base left-0 top-0 z-10 mt-7 md:mt-0 px-4 md:px-0"
    ...
    >
        ...
        <button
                ...
                class="absolute top-0 right-0 leading-snug font-400 text-3xl text-base-content hover:text-blue-600 focus:outline-none pr-7 md:pr-3"
                @click="reset"
        >&times;</button>
    ...
    <button
            ...
            type="button"
            class="flex md:hidden bg-green-500 hover:bg-blue-100 justify-center items-center border border-gray-500 rounded-full focus:outline-none h-10 px-3"
