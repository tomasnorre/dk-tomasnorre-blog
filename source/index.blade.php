        ...
        <div class="relative group grid grid-cols-1 lg:grid-cols-12 gap-0 mb-6 overflow-hidden rounded-3xl bg-slate-50 border border-slate-100">
            ...
            <div class="lg:col-span-5 p-8 lg:p-12 flex flex-col justify-center">
                ...
                <a href="{{ $featuredPost->getUrl() }}" class="group/link">
                    <h2 class="text-3xl lg:text-4xl font-black text-slate-900 leading-tight mb-4 group-hover/link:text-emerald-600 transition-colors">
                        {{ $featuredPost->title }}
                    </h2>
                    <div class="text-slate-600 line-clamp-3 mb-6 leading-relaxed">
